...
namespace StarToUp.Controllers
{
    public class EmpresaCadastrosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EmpresaCadastroID,Nome,Email,Senha,RazaoSocial,QtdFuncionario,Cep,Rua,Bairro,Numero,Complemento,Cidade,Estado,Logomarca,Objetivo,Hash,SegmentacaoID")] EmpresaCadastro empresaCadastro, HttpPostedFileBase logomarca)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EmpresaCadastroID,Nome,Email,Senha,RazaoSocial,QtdFuncionario,Cep,Rua,Bairro,Numero,Complemento,Cidade,Estado,Logomarca,Objetivo,Hash,SegmentacaoID")] EmpresaCadastro empresaCadastro, HttpPostedFileBase logomarca)
        {
            ViewBag.FotoMensagem = "";
            try
            {
