    ...
    public partial class atual : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        FundadorID = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.PerfilStartupID)
                .ForeignKey("dbo.Fundador", t => t.FundadorID, cascadeDelete: true)
                ...
                .Index(t => t.FundadorID);
            
            CreateTable(
                "dbo.Fundador",
                c => new
                    {
                        FundadorID = c.Int(nullable: false, identity: true),
                        Nome = c.String(unicode: false),
                        Cargo = c.String(unicode: false),
                        Foto = c.String(unicode: false),
                    })
                .PrimaryKey(t => t.FundadorID);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.PerfilStartup", "FundadorID", "dbo.Fundador");
            ...
            DropIndex("dbo.PerfilStartup", new[] { "FundadorID" });
