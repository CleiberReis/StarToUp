...
namespace StarToUp.Repositories
{
    public class Funcoes
    {
        public static bool AutenticarUsuario(string login, string senha)
        {
            ...
            var query = (from u in _db.Startups
                         where u.Email == login &&
                         u.Senha == senha
        ...
        public static Startup GetUsuario()
        {
           ...
           HttpContext.Current.Session["Usuario"] != null)
            {
                ...
                {
                    Context _db = new Context();
                    Startup startupCadastro = (from u in _db.Startups
        ...
        public static Startup GetUsuario(string _login)
        {
            if (_login == "")
            {
                return null;
